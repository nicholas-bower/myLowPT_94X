...
static constexpr auto s_tag = "[myLowPtGsfElectronsAnalyzer]";

TEST_CASE("Standard checks of myLowPtGsfElectronsAnalyzer", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("myLowPtGsfElectronsAnalyzer"
